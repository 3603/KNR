...
menu = st.sidebar.radio("Select Option on which case you need info about ", ("Home", "Aadhar Card", "Contact Us"))
...
if menu == "Home":
    ...
    db = FAISS.load_local("aadhar_vector_db", embeddings, allow_dangerous_deserialization=True)
